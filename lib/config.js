...
module.exports = {
	...
	set: function set(key, val) {
		...
		switch(p.length) {
			case 1: conf[p[0]] = val; break;
			case 2: conf[p[0]][p[1]] = val; break;
			case 3: conf[p[0]][p[1]][p[2]] = val; break;
			case 4: conf[p[0]][p[1]][p[2]][p[3]] = val; break;
			case 5: conf[p[0]][p[1]][p[2]][p[3]][p[4]] = val; break;
			case 6: conf[p[0]][p[1]][p[2]][p[3]][p[4]][p[5]] = val; break;
			case 7: conf[p[0]][p[1]][p[2]][p[3]][p[4]][p[5]][p[6]] = val; break;
		}
	},
