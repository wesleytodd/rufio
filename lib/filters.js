...
var Filters = module.exports = function(rufio) {
	...
	this.lookupPath(path.join(rufio.THEME_ROOT, 'filters'), 10);
	this.lookupPath(path.join(rufio.SITE_ROOT, 'filters'), 100);
	this.lookupPath(path.join(rufio.RUFIO_ROOT, 'filters'), 1000);
};
